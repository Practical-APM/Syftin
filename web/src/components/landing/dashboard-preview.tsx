    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl border border-graphite-700/60 bg-graphite-900 shadow-2xl shadow-graphite-950/40">
        ...
        <div className="flex min-h-[360px]">
          <aside className="hidden w-[140px] shrink-0 border-r border-graphite-700/60 bg-graphite-950 p-3 sm:block">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2.5 sm:grid-cols-4">
              {[
                ...
                >
                  ...
                  <p className="mt-0.5 text-base font-semibold text-ivory-50">
                    {stat.value}
                  </p>
                </div>
              ))}
